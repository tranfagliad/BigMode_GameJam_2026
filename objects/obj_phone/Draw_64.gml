...
draw_sprite_ext(spr_phone, 0, phone_x, current_y, phone_scale, phone_scale, 0, c_white, 1);

var _cx = phone_x + wave_center_x_offset;
var _cy = current_y + wave_center_y_offset;
