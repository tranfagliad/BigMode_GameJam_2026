...
// Outside/City Sounds
outside_bus = audio_bus_create();
outside_muffle = audio_effect_create(AudioEffectType.LPF2);
outside_muffle.cutoff = 800;
outside_muffle.q = 1.0;
outside_bus.effects[0] = outside_muffle;

outside_emitter = audio_emitter_create();
audio_emitter_bus(outside_emitter, outside_bus);
city_sounds_instance = audio_play_sound_on(outside_emitter, snd_city_sounds, true, 5);
audio_emitter_gain(outside_emitter, 1); 
